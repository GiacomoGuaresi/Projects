// Accesso con passphrase (doc/05-sicurezza.md): lo stesso account condiviso di
// Grocery, la passphrase ne è la password. Il resto dell'app conosce solo questa
// interfaccia; sotto c'è la sessione di Supabase, che le policy pretendono.
...
export interface Accesso {
  /** Vero se su questo dispositivo si è già entrati (anche da Grocery). */
