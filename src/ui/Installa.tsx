...
const istruzioni: Record<Piattaforma, string[]> = {
  ...
  desktop: [
    ...
    'Clicca l’icona di installazione a destra nella barra degli indirizzi, oppure menu ⋮ → “Installa Projects”.',
  ...
  return (
    <section className={riquadro}>
      ...
      <p className="text-testo-tenue">
        Installata si apre a schermo intero, come un'app. Per vedere e salvare le attività serve comunque la rete.
      </p>
